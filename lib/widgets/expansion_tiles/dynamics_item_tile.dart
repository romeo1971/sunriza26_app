          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                InkWell(
                  onTap: () => widget.onFlagNormalizeLipChanged(
                    !widget.flagNormalizeLip,
                  ),
                  child: Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        const SizedBox(width: 12),
                        _buildGradientSwitch(widget.flagNormalizeLip),
                      ],
                    ),
                  ),
                ),
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        const SizedBox(width: 12),
                        _buildGradientSwitch(widget.flagPasteback),
                      ],
                    ),
                  ),
                ),
